  ...
  return (
    <nav
      ...
      style={{
        ...
        backdropFilter: scrolled || open ? 'blur(16px)' : 'blur(12px)',
        WebkitBackdropFilter: scrolled || open ? 'blur(16px)' : 'blur(12px)',
        borderBottom: '1px solid var(--hair)',
        boxShadow: scrolled || open ? '0 8px 24px rgba(0,0,0,0.18)' : '0 4px 14px rgba(0,0,0,0.12)',
        display: 'flex',
